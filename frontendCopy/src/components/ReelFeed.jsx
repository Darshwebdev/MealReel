...
const ReelFeed = ({
  ...
  const fetchFoods = async (category = null) => {
    try {
      ...
      let url = "https://mealreel.onrender.com/api/food";
  ...
  const displayedItems = selectedCategory !== null ? foods : items;
        ...
        {displayedItems.length === 0 && (
          <div className="empty-overlay">
            <div className="empty-card">
              ...
              <button className="empty-btn" onClick={handleAllClick}>
                View All
              </button>
            </div>
          </div>
  ...
  <div className="reel-action__count">Partner</div>
              ...
              <div className="reel-content">
                ...
                <button
                  className="reel-btn"
                  onClick={() => handleShopNow(item._id)}
                  aria-label="Shop now"
                >
                  Shop Now ₹{item.price}
                </button>
